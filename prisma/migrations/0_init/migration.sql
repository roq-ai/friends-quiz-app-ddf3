...
CREATE TABLE "team_quiz" (
    ...
    CONSTRAINT "team_quiz_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "team_quiz" ADD CONSTRAINT "team_quiz_quiz_id_fkey" FOREIGN KEY ("quiz_id") REFERENCES "quiz"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "team_quiz" ADD CONSTRAINT "team_quiz_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "team"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
